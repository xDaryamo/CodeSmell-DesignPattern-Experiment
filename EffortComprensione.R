...
dataA <- read.xlsx("D:\\Test\\Results.xlsx", sheetIndex = 4, rowIndex = 1:9)
dataB <- read.xlsx("D:\\Test\\Results.xlsx", sheetIndex = 4, rowIndex = 10:18)
dataC <- read.xlsx("D:\\Test\\Results.xlsx", sheetIndex = 4, rowIndex = 19:26)
dataD <- read.xlsx("D:\\Test\\Results.xlsx", sheetIndex = 4, rowIndex = 27:35)
...
ggplot(dfA, aes(x = xVector[1], y = sav)) +
  ...
  labs(x = "Group Task Comprensione", y = "Effort(min)")